...
modelPath = 'E:\Traffic Sign Detection\\03-Classification\Models'
model = keras.models.load_model(modelPath+'/TSModel5')

ImagesFilePath='E:\Traffic-Sign-Recognition-master\Traffic-Sign-Recognition-master\TS Sences\Sences'
